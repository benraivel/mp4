...
WHERE  trips.bike_id = '27315' AND trips.start_time BETWEEN '2017-05-01 00:00:00' AND '2017-06-01 00:00:00';")
...
line_sf <- sf_bind %>%
  ...
  select(start_time, duration, start_station_id, end_station_id)

leaflet() %>%
  addTiles() %>%
  addPolylines(data = line_sf)
