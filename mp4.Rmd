...
point1df <- select(queried_data, pen15, avg_lon.x, avg_lat.x)
point2df <- select(queried_data, pen15, avg_lon.y, avg_lat.y)
...
leaflet() %>%
  addTiles() %>%
  addPolylines(data = point_sf, color = ~pal(pen15), opacity = 1)
```
